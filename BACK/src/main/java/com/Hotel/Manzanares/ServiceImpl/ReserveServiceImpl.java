...
public class ReserveServiceImpl implements ReserveService {
    ...
    @Override
    public String updateReserve(Long id,ReserveRequest reserveRequest) {
        String respuesta = "";
        ...
        try {
            ...
            // Obtener la reserva existente por ID
            Optional<Reserva> reservaOptional = reserveRepository.findById(id);
            ...
            reserva.setPrecioTotal(total_price);
            reserva.setActiva(true); // Podrías querer cambiar este valor según tu lógica de negocio

            // Guardar la reserva actualizada en el repositorio
            reserveRepository.save(reserva);

            respuesta = "Reserva actualizada con éxito";

        } catch (Exception e) {
            System.out.println("Error actualizando la reserva: " + e.getMessage());
            respuesta = "Error actualizando la reserva: " + e.getMessage();
        }
